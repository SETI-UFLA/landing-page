...
const Navbar = () => {
  ...
  return (
    <>
      {/* Mobile Navbar - Logo centralizada */}
      <nav className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-md border-b border-gray-800">
        <div className="container mx-auto px-4 py-3">
          <div className="flex justify-center">
            <img src={logo} alt="SE7I Logo" className="h-8 w-auto" />
          </div>
        </div>
      </nav>

      {/* Desktop Navbar - Com menu */}
