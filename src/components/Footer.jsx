...
const Footer = () => {
  return (
    <footer className="relative border-t border-gray-800 py-6 md:py-8">
      {/* Background gradient */}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 md:gap-8">
          ...
          {/* Desktop - Company Logos with Social Icons */}
          ...
          {/* Right Side - SE7I Logo and Copyright */}
          <div className="flex flex-col items-center gap-4">
            <img src={logo} alt="SE7I Logo" className="h-12 md:h-16 w-auto" />
